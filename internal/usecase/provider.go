...
type IUsecase interface {
	...
	RunPayroll(ctx *gin.Context, periodID uint) (*model.PayrollRun, []*model.PayrollItem, error)
	GeneratePayslip(ctx *gin.Context, userID, periodID uint) (*payslip.PayslipResponse, error)
}
